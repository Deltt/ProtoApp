...
RLAPI void ImageResize(Image *image, int resize_width, int resize_height);                                       // Resize image (Bicubic scaling algorithm)
RLAPI void ImageResizeNN(Image *image, int resize_width,int resize_height);                                      // Resize image (Nearest-Neighbor scaling algorithm)
RLAPI void ImageresizeCanvas(Image *image, int resize_width, int resize_height, int offsetX, int offsetY, Color fill); // Resize canvas and fill with color
