...
var ASM_CONSTS = {
  94096: () => { if (document.fullscreenElement) return 1; },  
 94142: () => { return document.getElementById('canvas').width; },  
 94194: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94262: () => { document.exitFullscreen(); },  
 94289: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 94362: () => { if (document.fullscreenElement) return 1; },  
 94408: () => { return document.getElementById('canvas').width; },  
 94460: () => { return screen.width; },  
 94485: () => { document.exitFullscreen(); },  
 94512: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 94645: () => { return window.innerWidth; },  
 94671: () => { return window.innerHeight; },  
 94698: () => { if (document.fullscreenElement) return 1; },  
 94744: () => { return document.getElementById('canvas').width; },  
 94796: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94864: () => { if (document.fullscreenElement) return 1; },  
 94910: () => { return document.getElementById('canvas').width; },  
 94962: () => { return screen.width; },  
 94987: () => { return window.innerWidth; },  
 95013: () => { return window.innerHeight; },  
 95040: () => { if (document.fullscreenElement) return 1; },  
 95086: () => { return document.getElementById('canvas').width; },  
 95138: () => { return screen.width; },  
 95163: () => { document.exitFullscreen(); },  
 ...
 95356: () => { document.exitFullscreen(); },  
 95383: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 95441: () => { return screen.width; },  
 95466: () => { return screen.height; },  
 95492: () => { return window.screenX; },  
 95519: () => { return window.screenY; },  
 95546: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 95599: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 95670: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 95727: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 95983: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 96054: () => { if (document.fullscreenElement) return 1; },  
 96100: () => { return window.innerWidth; },  
 96126: () => { return window.innerHeight; },  
 96153: () => { if (document.pointerLockElement) return 1; }
};
